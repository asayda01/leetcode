...
function collectMaxRocks(grid, row, col, memo) {
    ...
    const rocksFromLeft = collectMaxRocks(grid, row, col - 1, memo);
    const rocksFromBelow = collectMaxRocks(grid, row - 1, col, memo);
